...
public class Ch3Ex2Activity extends AppCompatActivity {
    ...
    private void resetTargetAnimation() {
        ...
        ObjectAnimator scaleXAnimator = ObjectAnimator.ofFloat(target, "scaleX",
                1.0f,2.0f);
        ...
        ObjectAnimator scaleYAnimator = ObjectAnimator.ofFloat(target, "scaleY",
                1.0f,2.0f);
        ...
        ObjectAnimator transparency = ObjectAnimator.ofFloat(target, "alpha",
                1f,0.5f);
        transparency.setRepeatCount(ObjectAnimator.INFINITE);
        transparency.setDuration(Integer.parseInt(durationSelector.getText().toString()));
        transparency.setRepeatMode(ObjectAnimator.REVERSE);

        // TODO ex2-3: 将上面创建的其他 ObjectAnimator 都添加到 AnimatorSet 中
        animatorSet = new AnimatorSet();
        animatorSet.playTogether(animator1,scaleXAnimator,scaleYAnimator,transparency);
        animatorSet.start();
    }
}
